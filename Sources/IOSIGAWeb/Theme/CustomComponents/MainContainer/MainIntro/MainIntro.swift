...
struct MainIntro: Component {
    ...
    var body: Component {
        Div {
            ...
            Div{
                Paragraph(
                    "iOS iGA(iOS 아이가)는 개발자 뿐만 아니라 개발에 관심 있는 모두에게 열려있는 부산지역 커뮤니티입니다."
                )
                Paragraph("누구나 자유롭게 지식을 공유하고 성장할 수 있는 공간을 제공합니다.")
            }.class("main-description")
            Div {
                Paragraph("이번 세미나에서는 ML을 주제로 Swift에서의 활용방안을 소개합니다. ")
                Paragraph("기술들을 조합했을 때 새로운 시야가 펼쳐질 것을 기대합니다.")
                Paragraph("Swift로 개발자를 시작하실 분, ML을 활용해 iOS App 을 만들고 싶은 분, ")
